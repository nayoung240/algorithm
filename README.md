...
[문제](https://leetcode.com/problems/count-number-of-rectangles-containing-each-point/description/) ▪▪ [풀이](/binary/countrectangles.py)
...
- = 기억하기 알고리즘 : 연산한 내용을 기억해 놓고, 다음에도 그 연산이 필요할 때 기억해놓은 값을 사용해서 문제를 푸는 것. 
- 완전 탐색/DFS/BFS로 풀 수는 있지만, 경우의 수가 너무 많은 문제. 
  - 보통 DFS/BFS 로 풀 수 있는 최대 경우의 수 : 500만 개(5*10^6) 그 이상일 경우, DP를 어떻게 구현할지 고민해봐야한다. 
...
### 주의사항
- 방문 Check를 반드시 큐에 '넣기 전'에 해주어야 한다.
